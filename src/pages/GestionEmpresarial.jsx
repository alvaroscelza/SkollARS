            ...
            <main id="home" className="bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16 md:pt-28 md:pb-24 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                    ...
                    <div className="hidden md:block">
                        <img src="/img/products/odoo.png" alt="Software Odoo ERP - Gestión empresarial integral con módulos de inventario, ventas y facturación" className="rounded-lg shadow-2xl mb-3" loading="lazy" />
