            ...
            <main id="hero" className="bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-16 md:pt-24 md:pb-24 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="hidden md:block">
                        <img src="/img/products/finapp.png" alt="Dashboard de Finanzas Personales - Software de gestión financiera personal" className="rounded-xl shadow-2xl border-4 border-gray-800" loading="lazy" />
                    </div>
                </div>
            </main>
