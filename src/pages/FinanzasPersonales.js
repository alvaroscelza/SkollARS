                ...
                <div className="bg-white rounded-xl shadow-lg p-8">
                    ...
                    <div className="prose max-w-none">
                        ...
                        <ul className="list-disc list-inside space-y-2 text-gray-700 mb-6">
                            <li>Gestión completa de ingresos y gastos</li>
                            <li>Seguimiento de inversiones</li>
                            <li>Análisis de presupuestos</li>
                            <li>Reportes y gráficos detallados</li>
                            <li>Interfaz intuitiva y fácil de usar</li>
                        </ul>
                        <h2 className="text-2xl font-semibold text-gray-800 mb-4">¿Quieres saber más?</h2>
                        <p className="text-gray-700 mb-6">
                            Si estás interesado en conocer más detalles sobre esta solución o tienes preguntas, no dudes en contactarnos.
                        </p>
